...
public interface ClientCommsInterface {
    /**
     * @param data String value to send back to main UI Thread.
     */
    void sendDataToUIThread(String data);

    /**
     * @param data integer value to send back to main UI Thread.
     */
    void sendDataToUIThread(int data);

    /**
     * @param data byte[] value to send back to main UI Thread.
     */
    void sendDataToUIThread(byte[] data);

    /**
     * @param data String value to send back to main UI Thread.
     * @param type integer values to specify the type of data to be sent.
     */
    void sendDataToUIThread(String data, int type);

    /**
     * @param data String value to send back to output stream.
     */
    void sendDataToOutputStream(String data);

    /**
     * @param data integer value to send back to output stream.
     */
    void sendDataToOutputStream(int data);

    /**
     * @param data byte[] value to send back to output stream.
     */

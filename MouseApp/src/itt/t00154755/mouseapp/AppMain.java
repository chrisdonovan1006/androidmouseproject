 ...
 *         <p>
 *         The Accelerometer data is read from here and passed on to the client and from the client to the server. This is also handled incoming data
 *         <p>
 *         from the AppClient, AppBTDevice and AppService classes. It is the main UI app to the user interacts all of the preferences link back to this class.
 *         <p>
 *         Refs:
 *         <p>
...
public class AppMain extends Activity
{
	...
	public synchronized void onResume()
	{
		...
		if ( appClient.getState() == AppClient.CONNECTED )
		{
			...
			{
				// if the appService has already been registered no need start it again
				return;
			}
			else
			{
	...
	private void setUpAppService()
	{
		...
		appService = new AppService(this.getApplicationContext(),
									appHandler,
									appWindow);
		// start the service
